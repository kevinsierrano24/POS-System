          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div>
                ...
                <a href="{{ route('supplier.create') }}"> <button class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i> Tambah Toko</button></a>
                @endif
              </div><br>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $supplier->nama_supplier }}</td>
                      @if(Auth::user()->akses == 'admin')
                      <td>{{ $supplier->kode_cabang }}</td>
                    <td>
                      <a href="supplier/{{$supplier->id_supplier}}/edit"><button class="btn btn-warning btn-xs">Edit</button></a>
                      <a href="supplier/{{$supplier->id_supplier}}/delete"><button class="btn btn-danger btn-xs">Delete</button></a>
                    </td>
                      @endif
                  </tr>
                  @endforeach
