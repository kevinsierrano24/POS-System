          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div>
                ...
                <a href="{{ route('suratjalan.index') }}"> <button class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i> Buat Surat Jalan</button></a>
                @endif
              </div><br>
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="print">
                    @if(Auth::user()->akses == 'admin')
                    <a href="/purchase/{{$supplier->no_po}}/delete"><button class="btn btn-danger btn-sm">Delete</button></a>
                       
                      @endif
                      <a href="/purchase/{{$supplier->no_po}}/print"><button class="btn btn-warning btn-sm">print</button></a>
